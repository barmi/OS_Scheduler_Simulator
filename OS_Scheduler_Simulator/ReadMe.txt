================================================================================
    MFC 라이브러리 : OS_Scheduler_Simulator 프로젝트 개요
================================================================================

응용 프로그램 마법사에서 이 OS_Scheduler_Simulator 응용 프로그램을 
만들었습니다. 이 응용 프로그램은 MFC의 기본 사용법을 보여 줄 뿐만 아니라 응용 
프로그램작성을 위한 기본 구조를 제공합니다.

이 파일에는 OS_Scheduler_Simulator 응용 프로그램을 구성하는 각 파일에 대한
요약 설명이 포함되어 있습니다.

OS_Scheduler_Simulator.vcxproj
...
OS_Scheduler_Simulator.vcxproj.filters
...
OS_Scheduler_Simulator.h
    응용 프로그램의 기본 헤더 파일입니다. 여기에는 다른 프로젝트 관련
    헤더(Resource.h 포함)가 들어 있고 COS_Scheduler_SimulatorApp 응용 프로그램
    클래스를 선언합니다.

OS_Scheduler_Simulator.cpp
    응용 프로그램 클래스 COS_Scheduler_SimulatorApp이(가) 들어 있는 기본 응용 프로그램
    소스 파일입니다.

OS_Scheduler_Simulator.rc
...
res\OS_Scheduler_Simulator.ico
    응용 프로그램의 아이콘으로 사용되는 아이콘 파일입니다. 이 아이콘은
    주 리소스 파일인 OS_Scheduler_Simulator.rc에 의해 포함됩니다.

res\OS_Scheduler_Simulator.rc2
...
StdAfx.h, StdAfx.cpp
    이 파일은 미리 컴파일된 헤더 파일(PCH)인 OS_Scheduler_Simulator.pch와
...
OS_Scheduler_Simulator.manifest
